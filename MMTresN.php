...
if ($N1 < $N2 and $N1 < $N3) { print "O primeiro número informado, $N1, é menor que os demais.\n"};
elseif ($N2 < $N1 and $N2 < $N3) { print "O segundo número informado, $N2, é menor que os demais.\n"};
elseif ($N3 < $N1 and $N3 < $N2) { print "O terceiro número informado, $N3, é o menor que os demais.\n"};
